...
const videoId = 'Mvh4o6x3-GQ';

/!*fetchCommentsWithReplies(videoId)
    .then(allCommentsWithReplies => {
        console.log(JSON.stringify(allCommentsWithReplies, null, 4));
        fs.writeFileSync('mrBeast_ytComments_yhB3BgJyGl8.json', allCommentsWithReplies)
    });*!/
...
fetchCommentsWithReplies(videoId)
    .then(allCommentsWithReplies => {
        ...
        const jsonContent = JSON.stringify(allCommentsWithReplies, null, 4);

        // Write JSON content to a file
        fs.writeFile('ytComments_v0vY5V4jYhE_rogan_12Aug.json', jsonContent, 'utf8', err => {
            if (err) {
